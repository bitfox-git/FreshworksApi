...
namespace Bitfox.Freshworks.Models
{
    ...
    public class Account: Includes, IHasInsert<Account>, IHasUpdate, IHasClone, IHasView, IHasDelete, IHasDeleteBulk, IHasForget, IHasFields, IHasFilters, IHasUniqueID
    {
        [JsonParentProperty]
